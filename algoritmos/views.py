...
def index(request):
    ...
    archivo = open(x+"\SigVerRSA_PSS.txt","r") 
    for linea in archivo.readlines():
        if "n = " in linea:#Lee el parametro n del archivo
            fn = linea.lstrip("n = ")
            listn.append(fn.rstrip("\n"))
    ...
    archivo = open(x+"\SigGenRSA_PSS.txt","r") 
    for linea in archivo.readlines():
        if "n = " in linea:#Lee el parametro n del archivo
            fn = linea.lstrip("n = ")
            listn.append(fn.rstrip("\n"))
    ...
    context = {
        'listEBC_C':tmp_promAES[0],
        'listEBC_D':tmp_promAES[1],
        'listCBC_C':tmp_promAES[2],
        'listCBC_D':tmp_promAES[3],
        'listaTmpoSHA384': tmp_promSHA[0],
        'listaTmpoSHA512': tmp_promSHA[1],
        'listaTmpoSHA3_384': tmp_promSHA[2],
        'listaTmpoSHA3_512': tmp_promSHA[3],
        'timeGenRSA_OAEP': tmp_promRSA[0],
        'timeVerRSA_OAEP': tmp_promRSA[1],
        'timeGenRSA_PSS': tmp_promRSA[2],
        'timeVerRSA_PSS': tmp_promRSA[3],
        'encrypTime': tmp_promRSA[4],
        'decrypTime': tmp_promRSA[5],
        'timeGenDSA': tmp_promDSA[0],
        'timeVerDSA': tmp_promDSA[1],
        'timeGenECC_521': tmp_promECDSA[0],
        'timeVerECC_521': tmp_promECDSA[1],
        'timeGenECC_384': tmp_promECDSA[2],
        'timeVerECC_384': tmp_promECDSA[3],
    }
...
def aes(request):
    ...
    listvector = ["EBC_AES.rsp","CBC_AES.rsp"]
    timelist = zip(listEBC_C, listEBC_D, listCBC_C, listCBC_D)
    tmp_promAES = [statistics.mean(listEBC_C), statistics.mean(listEBC_D),statistics.mean(listCBC_C), statistics.mean(listCBC_D)]
...
def sha(request):
    ...
    listvector = ["\SHA384ShortMsg.rsp", "\SHA384LongMsg.rsp", "\SHA512ShortMsg.rsp", "\SHA512LongMsg.rsp", "\SHA3_384ShortMsg.rsp", "\SHA3_384LongMsg.rsp", "\SHA3_512ShortMsg.rsp", "\SHA3_512LongMsg.rsp"]
    timelist = zip(listaTmpoSHA384, listaTmpoSHA512, listaTmpoSHA3_384, listaTmpoSHA3_512)
    tmp_promSHA=[statistics.mean(listaTmpoSHA384),statistics.mean(listaTmpoSHA512),statistics.mean(listaTmpoSHA3_384), statistics.mean(listaTmpoSHA3_512)]
    context = {
        'timelist': timelist,
        'listaTmpoSHA384': tmp_promSHA[0],
...
def rca(request):
    ...
    listvector = ["\SigGenRSA_OAEP.txt", "\SigVerRSA_PSS.txt", "\SigGenRSA_PSS.txt", "\SigVerRSA_PSS.txt"]
    timelist = zip(timeGenRSA_OAEP, timeVerRSA_OAEP, timeGenRSA_PSS, timeVerRSA_PSS, encrypTime, decrypTime)
    tmp_promRSA=[statistics.mean(timeGenRSA_OAEP), statistics.mean(timeVerRSA_OAEP), statistics.mean(timeGenRSA_PSS), statistics.mean(timeVerRSA_PSS), statistics.mean(encrypTime), statistics.mean(decrypTime)]
    context = {
        'timeGenRSA_OAEP': tmp_promRSA[0],
        'timeVerRSA_OAEP': tmp_promRSA[1],
...
def dsa(request):
    ...
    listvector = ["\SigGenDSA.txt", "\SigVerDSA.rsp"]
    timelist = zip(timeGenDSA, timeVerDSA)
    tmp_promDSA=[statistics.mean(timeGenDSA), statistics.mean(timeVerDSA)]
    context = {
        'timeGenDSA': tmp_promDSA[0],
        'timeVerDSA': tmp_promDSA[1],
...
def ecdsa(request):
    ...
    listvector = ["\ECC_P521_GEN.txt", "\ECC_P521_VER.txt", "\ECC_P384_GEN.txt", "\ECC_P384_VER.txt"]
    timelist = zip(timeGenECC_521, timeVerECC_521, timeGenECC_384, timeVerECC_384)
    tmp_promECDSA=[statistics.mean(timeGenECC_521), statistics.mean(timeVerECC_521), statistics.mean(timeGenECC_384), statistics.mean(timeVerECC_384)]
    context = {
        'timeGenECC_521': tmp_promECDSA[0],
        'timeVerECC_521': tmp_promECDSA[1],
